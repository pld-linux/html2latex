...
przekształacania obiektów HTML::Element do plików LaTeXa. Każdy URL
zostaje pozbawiony rozszerzenia .*html. W przypadku użycia URL-a pliki
pobrane z Internetu zostaną zapisane w katalogu ~/.html2latex.
Załączone obrazki są przekształcane do formatu .PNG, który może być
wykorzystany przez pdflatexa. Jako dodatek istnieje opcja
automatycznego tworzenia dokumentu PDF z pliku LaTeXa (przy użyciu
pdflatexa).
